...
def get_pretraining_stl10(data_dir,ratio):
    train_data = CIFAR10Pair(numpy_file='/home/jspi/data/HTX/DATA/BadEncoder/stl10/' + "train_unlabeled.npz", class_type= classes, transform=train_transform,ratio=ratio)
    memory_data = CIFAR10Mem(numpy_file='/home/jspi/data/HTX/DATA/BadEncoder/stl10/' + "train.npz", class_type= classes, transform=test_transform_stl10,ratio=ratio)
    test_data  = CIFAR10Mem(numpy_file='/home/jspi/data/HTX/DATA/BadEncoder/stl10/' + "test.npz", class_type= classes,transform=test_transform_stl10)
